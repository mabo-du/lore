...
class TranslationWorker(QThread):
    ...
    segment_translated = pyqtSignal(Segment) # Emits segment once its .translation is set
    finished = pyqtSignal(Transcript)
    error = pyqtSignal(str)

    def __init__(self, transcript: Transcript, target_lang_code: str, source_lang_code: str = "eng_Latn", parent=None):
    ...
    def run(self):
        try:
            ...
            tokenizer = transformers.AutoTokenizer.from_pretrained(model_dir, src_lang=self.source_lang_code)
